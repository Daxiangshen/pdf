...
public class Test {
	...
	public static void main(String[] args) throws Throwable {
		...
		String htmlBasePath="E://code//study_simple_demo//src//main//resources//template";//html的根目录
		String tempathBasePath=Test.class.getResource("/").getPath()+"template/";//模板路径
		String pdfBasePath="E://code//study_simple_demo//src//main//resources//template";//生成的pdf目录
		
		String barCodePath="E://code//study_simple_demo//src//main//resources//images//"+uuid+".png";
		...
		dataMap.put("userName", "YuXiang");
		dataMap.put("submitDate", "2019-09-18");
		dataMap.put("deptName", "Test");
		//费用明细
